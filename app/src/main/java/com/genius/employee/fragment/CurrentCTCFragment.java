 ...
 */
public class CurrentCTCFragment extends Fragment {
    ...
    TextView tvEffDate, tvMonthlyGross, tvYearlyGross, tvMonthlyCTC, tvYearlyCTC;
    RecyclerView rvItem;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_current_ctc, container, false);
        init();
        getCTC();
        return view;
    }
    ...
    private void init() {
        ...
        tvEffDate = (TextView) view.findViewById(R.id.tvEffDate);
        tvMonthlyGross = (TextView) view.findViewById(R.id.tvMonthlyGross);
        tvYearlyGross = (TextView) view.findViewById(R.id.tvYearlyGross);
        tvMonthlyCTC = (TextView) view.findViewById(R.id.tvMonthlyCTC);
        tvYearlyCTC = (TextView) view.findViewById(R.id.tvYearlyCTC);
