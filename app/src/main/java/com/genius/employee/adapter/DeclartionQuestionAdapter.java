...
public class DeclartionQuestionAdapter extends RecyclerView.Adapter<DeclartionQuestionAdapter.MyViewHolder> {
        ...
        myViewHolder.llAgree.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (qeuModel.isSelected()) {
                    ...
                    ((Declation2Activity) context).updateStatus(i, true);



                } else {

                    ((Declation2Activity) context).updateStatus(i, false);
    ...
    public DeclartionQuestionAdapter(ArrayList<Declarition2Model> itemList, Context context) {
