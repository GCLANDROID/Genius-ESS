...
public class VisitEmployeeListAdapter extends RecyclerView.Adapter<VisitEmployeeListAdapter.MyViewHolder> {
    ...
    public VisitEmployeeListAdapter(ArrayList<EmployeeListModel> itemList, Context context) {
