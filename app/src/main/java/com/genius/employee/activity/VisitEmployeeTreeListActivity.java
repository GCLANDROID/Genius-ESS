...
import com.genius.employee.adapter.EmployeeListAdapter;
...
public class VisitEmployeeTreeListActivity extends AppCompatActivity {
    ...
    //https://cloud.geniusconsultant.com/GeniusESS/API/ManageEmployee/HierarchyList?EmployeeID=2070002087&LevelID=2060000003&DeptID=49&BrID=1100000001
    ...
    private void initView(){
        ...
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(VisitEmployeeTreeListActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void setBranch() {
        ...
        Log.d("compurl", surl);
        final ProgressDialog pd=new ProgressDialog(VisitEmployeeTreeListActivity.this);
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>
                                        (VisitEmployeeTreeListActivity.this, android.R.layout.simple_spinner_item,
                            ...
                            e.printStackTrace();
                            Toast.makeText(VisitEmployeeTreeListActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
       ...
       // String surl = "https://cloud.geniusconsultant.com/GeniusESS/API/ManageEmployee/HierarchyList?EmployeeID="+pref.getEmpId()+"&LevelID="+lebelId+"&DeptID="+pref.getDeptId();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, st_url,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(VisitEmployeeTreeListActivity.this, "volly 2" + error.toString(), Toast.LENGTH_LONG).show();
                Log.e("ert", error.toString());
            }
        }) {
            @Override
    ...
    private void setAdapter(){
        VisitEmployeeListAdapter eAdapter=new VisitEmployeeListAdapter(itemList, VisitEmployeeTreeListActivity.this);
