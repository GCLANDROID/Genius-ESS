...
import com.genius.employee.adapter.VisitingLocationAdapter;
...
public class TourViewReportActivity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        String date=getIntent().getStringExtra("attdate").replaceAll("\\s+", " ");
    ...
    private void getItem(String date){
        ...
        String surl = APi.sGetClientVisitReportByDateApi+"EmployeeId="+pref.getSecureEmpId()+"&logDate="+date;
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i <responseData.length(); i++) {
                                    ...
                                    String PunchInTime = obj.optString("EnteredOn");
                                    String AddressIN = obj.optString("ENTRY_ADDRESS");
                                    String LongitudeIN=obj.optString("ENTRY_MARK_LON");
                                    String LatitudeIN=obj.optString("ENTRY_MARK_LAT");
