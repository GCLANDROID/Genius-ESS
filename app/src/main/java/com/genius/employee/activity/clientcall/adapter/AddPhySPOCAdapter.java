...
public class AddPhySPOCAdapter extends RecyclerView.Adapter<AddPhySPOCAdapter.MyViewHolder> {
    ...
    public AddPhySPOCAdapter(ArrayList<AddSPOCModel> itemList, Context context) {
