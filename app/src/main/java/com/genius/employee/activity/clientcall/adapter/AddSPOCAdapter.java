...
public class AddSPOCAdapter extends RecyclerView.Adapter<AddSPOCAdapter.MyViewHolder> {
    ArrayList<AddSPOCModel>itemList=new ArrayList();
    Context context;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
      ...
      myViewHolder.imgCross.setOnClickListener(new View.OnClickListener() {
          @Override
      ...
      myViewHolder.llViewDetails.setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View view) {
              ((VirtualCallRegistrationActivity)context).showSPOCDetails(i);
          }
      });
    ...
    public AddSPOCAdapter(ArrayList<AddSPOCModel> itemList,Context context) {
