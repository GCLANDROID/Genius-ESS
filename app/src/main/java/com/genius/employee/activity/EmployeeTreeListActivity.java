...
public class EmployeeTreeListActivity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        LinearLayoutManager layoutManager
                = new LinearLayoutManager(EmployeeTreeListActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void setBranch() {
        ...
        Log.d("compurl", surl);
        final ProgressDialog pd=new ProgressDialog(EmployeeTreeListActivity.this);
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>
                                        (EmployeeTreeListActivity.this, android.R.layout.simple_spinner_item,
                            ...
                            e.printStackTrace();
                            Toast.makeText(EmployeeTreeListActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
    ...
    private void getItem(String branchId) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, st_url,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(EmployeeTreeListActivity.this, "volly 2" + error.toString(), Toast.LENGTH_LONG).show();
                Log.e("ert", error.toString());
            }
        }) {
            @Override
    ...
    private void setAdapter(){
        EmployeeListAdapter eAdapter=new EmployeeListAdapter(itemList,EmployeeTreeListActivity.this);
