...
public class ReachedOfficeLogActivity extends AppCompatActivity {
    TextView tvSave;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reached_office_log);
        initView();
        onClick();
    }
    ...
    private void onClick(){
        tvSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    Intent intent=new Intent(ReachedOfficeLogActivity.this, ReachedOfficeActivity.class);
    ...
    public void showReachedpopUp() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(ReachedOfficeLogActivity.this, R.style.CustomDialogNew);
